...
RSpec.describe SuperAuth do
  ...
  it "users<->groups<->roles<->permissions<->resources" do
    ...
    edges = SuperAuth::ActiveRecord::Edge.users_groups_roles_permissions_resources.sort_by { |v| [v[:group_path].to_s, v[:user_name].to_s] }
  ...
  it "users<->groups<->permissions<->resources" do
    ...
    edges = SuperAuth::ActiveRecord::Edge.users_groups_permissions_resources.sort_by { |v| [v[:group_path].to_s, v[:user_name].to_s] }
  ...
  it "users<->roles<->permissions<->resources" do
    ...
    edges = SuperAuth::ActiveRecord::Edge.users_roles_permissions_resources.sort_by { |v| [v[:group_path].to_s, v[:user_name].to_s] }
